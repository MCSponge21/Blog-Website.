...
export default function ViewPost() {
    ...
    const postComment = async (e) => {
        ...
        const res = await Axios({ method: 'post', url: `https://server-production-9d6d.up.railway.app/api/comments/${params.id}`, headers: { 'Authorization': localStorage.getItem("SavedToken") }, data: { comment } });
        const getData = async () => {
            const res = await Axios.get(`https://server-production-9d6d.up.railway.app/api/comments/${params.id}`);
            setComments(res.data);
        }
    ...
    const editComment = async (e) => {
        e.preventDefault();
        const res = await Axios({ method: 'put', url: `https://server-production-9d6d.up.railway.app/api/comments/${commentId}`, headers: { 'Authorization': localStorage.getItem("SavedToken") }, data: { edit } });
        const getData = async () => {
            const res = await Axios.get(`https://server-production-9d6d.up.railway.app/api/comments/${params.id}`);
            setComments(res.data);
        }
